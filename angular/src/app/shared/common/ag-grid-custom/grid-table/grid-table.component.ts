...
import { AllModules, RangeSelectionModule, RichSelectModule, RowGroupingModule } from '@ag-grid-enterprise/all-modules';
...
export class GridTableComponent extends AppComponentBase implements OnInit {
    ...
    @Input() rowData: any[] = [];
    @Input() modules: Module[] = AllModules//[ClientSideRowModelModule, RangeSelectionModule, RowGroupingModule, RichSelectModule ];
