...
export class AppNavigationService {
    ...
    getMenu(): AppMenu {
        return new AppMenu('MainMenu', 'MainMenu', [
            ...
            new AppMenuItem('Gói quỹ hệ thống', 'Pages.Administration', 'flaticon-line-graph', '/app/admin/fundPackage'),
            new AppMenuItem('Quản lý đăng ký gói quỹ', 'Pages.Administration', 'flaticon-line-graph', '/app/admin/fundPackage-user'),
            new AppMenuItem('Yêu cầu gây quỹ', 'Pages.Administration', 'flaticon-line-graph', '/app/admin/request-to-fundraiser'),
            new AppMenuItem('Bài đăng gây quỹ', 'Pages.FundRaising', 'flaticon2-analytics-2', '/app/admin/admin-post'),
