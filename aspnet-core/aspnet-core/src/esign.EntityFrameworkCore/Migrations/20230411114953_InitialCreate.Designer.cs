...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("esign.Inv.Proc.InvesignuctionMapping", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex(new[] { "Grade" }, "IX_InvesignuctionMapping_Amount");

                    b.HasIndex(new[] { "AmountVn" }, "IX_InvesignuctionMapping_AmountVn");

                    b.HasIndex(new[] { "CifVn" }, "IX_InvesignuctionMapping_CifVn");

                    b.HasIndex(new[] { "UseLotNo" }, "IX_InvesignuctionMapping_ContSize");

                    b.HasIndex(new[] { "LotNo" }, "IX_InvesignuctionMapping_Fob");

                    b.HasIndex(new[] { "NoInLot" }, "IX_InvesignuctionMapping_InlandCharge");

                    b.HasIndex(new[] { "Model" }, "IX_InvesignuctionMapping_InvoiceNo");

                    b.HasIndex(new[] { "Shop" }, "IX_InvesignuctionMapping_PlanSequence");

                    b.HasIndex(new[] { "TimeIn" }, "IX_InvesignuctionMapping_PriceVn");

                    b.ToTable("InvesignuctionMapping");
                });
            ...
            modelBuilder.Entity("esign.Plan.Ccr.PlnCcresignuctionPlan", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex(new[] { "LotNo" }, "IX_PlnCcresignuctionPlan_LotNo");

                    b.HasIndex(new[] { "NoInLot" }, "IX_PlnCcresignuctionPlan_NoInLot");

                    b.HasIndex(new[] { "Shop" }, "IX_PlnCcresignuctionPlan_Shop");

                    b.ToTable("PlnCcresignuctionPlan");
                });

            modelBuilder.Entity("esign.Plan.Ccr.PlnCcresignuctionPlan_T", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex(new[] { "LotNo" }, "IX_PlnCcresignuctionPlan_T_LotNo");

                    b.HasIndex(new[] { "NoInLot" }, "IX_PlnCcresignuctionPlan_T_NoInLot");

                    b.HasIndex(new[] { "Shop" }, "IX_PlnCcresignuctionPlan_T_Shop");

                    b.ToTable("PlnCcresignuctionPlan_T");
                });
