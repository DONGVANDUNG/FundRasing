        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetNotifiers = table.Column<string>(maxLength: 131072, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GoogleAuthenticatorKey = table.Column<string>(maxLength: 328, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DarkLogoFileType = table.Column<string>(maxLength: 64, nullable: true),
                    DarkLogoId = table.Column<Guid>(nullable: true),
                    DeleterUserId = table.Column<long>(nullable: true),
                    DeletionTime = table.Column<DateTime>(nullable: true),
                    EditionId = table.Column<int>(nullable: true),
                    IsActive = table.Column<bool>(nullable: false),
                    ...
                    LastModificationTime = table.Column<DateTime>(nullable: true),
                    LastModifierUserId = table.Column<long>(nullable: true),
                    LightLogoFileType = table.Column<string>(maxLength: 64, nullable: true),
                    LightLogoId = table.Column<Guid>(nullable: true),
                    ...
                    SubscriptionPaymentType = table.Column<int>(nullable: true),
            ...
            migrationBuilder.CreateTable(
               ...
               columns: table => new
               {
                   ...
                   ReceivingTime = table.Column<DateTime>(nullable: true),
                   SharedMessageId = table.Column<long>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    DisplayName = table.Column<string>(maxLength: 96, nullable: true),
