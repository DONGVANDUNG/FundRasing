...
namespace esign.Web.TagHelpers
{
    ...
    public class esignPageSubheaderTagHelper : TagHelper
    {
        ...
        public esignPageSubheaderTagHelper(IUiThemeCustomizerFactory uiThemeCustomizerFactory)
        {
