...
using esign.Authorization.Permissions;
...
using esign.Web.Areas.App.Models.Roles;
using esign.Web.Areas.App.Models.Users;
...
namespace esign.Web.Areas.App.Controllers
{
    [Area("App")]
    [AbpMvcAuthorize]
    public class UsersController : esignControllerBase
    {
