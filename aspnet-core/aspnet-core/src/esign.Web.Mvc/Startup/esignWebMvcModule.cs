...
namespace esign.Web.Startup
{
    ...
    public class esignWebMvcModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public esignWebMvcModule(IWebHostEnvironment env)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(esignWebMvcModule).GetAssembly());
        }
