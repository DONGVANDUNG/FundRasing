...
using esign.Auditing.Exporting;
using esign.Authorization;
using esign.Authorization.Users;
using esign.Dto;
using esign.EntityHistory;
using EntityHistoryHelper = esign.EntityHistory.EntityHistoryHelper;

namespace esign.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : esignAppServiceBase, IAuditLogAppService
    {
